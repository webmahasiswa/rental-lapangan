...
<body onload="window.print()">
	<a href="halaman_user.php">kembali ke awal</a>
<?php 
  include "koneksi.php";
...
echo "  <center><h2>Bukti Booking</h2></center><p class='lead' style='float:right;' >*harap disimpan sebagai bukti waktu pemakaian lapangan</p>
		<table width=100% cellpadding=6>
          <tr style='color:white; height:35px;' bgcolor=#6495ed>
			...
			<th class='data'><center>Fasilitas</center></th>
			<th class='data'><center>     Catatan     </center></th>
          </tr>";



    $tampil = mysqli_query($koneksi, "SELECT * FROM tb_booking ORDER BY id_booking DESC limit 1");
    ...
    while($r=mysqli_fetch_assoc($tampil)){
      ...
      echo "<tr bgcolor=#dcdcdc; class='data'>
		...
		<td class='data'><center>$r[id_Fasilitas]</center></td>
		<td><br></td>
		</tr>";
