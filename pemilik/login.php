								...
								<div class="text">
									...
									<form action="cek_login.php" method="post">
										<div class="form-group">
											...
											<input type="password" class="form-control" placeholder="password" name="password_pemilik"><br>
										</div>
										...
										<div class="form-group">
											<br>
											<h5 class="lead">belum punya akun? silahkan daftar <a href="sign_up.php">disini</a></h5>
											<br>
										</div>
...
<div class="jumbotron bg-primary">
  <h6 align="center"><a href="login.php" style="color: white;">Kembali ke atas</a></h6>
