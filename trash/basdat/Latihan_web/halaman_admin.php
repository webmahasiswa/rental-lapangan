	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-primary">
		<div class="container">
  		...
  		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <a class="nav-item nav-link enable" href="jadwal.php" tabindex="-1" aria-enable="true">Data Booking</a>
            <a class="nav-item nav-link enable" href="#" tabindex="-1" aria-enable="true">Data Pengunjung</a>
            <a class="nav-item nav-link enable" href="#" tabindex="-1" aria-enable="true">Data Admin</a>
    		</div>
