...
<div class="jumbotron">
	<div class="container text-center" style="margin-top: 10%; margin-bottom: 15%;">
      ...
      <p class="lead">untuk booking lapangan anda harus memiliki akun web ini, jika belum punya akun silahkan buat akun disini <a href="form1.php" role="link">Buat Akun</a></p>
