	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-primary">
		<div class="container">
  		...
  		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <a class="nav-item nav-link active" href="data_pemilik.php" tabindex="-1" aria-enable="true">data pemilik</a>
      ...
      <tbody>
        ...
        while ($data = mysqli_fetch_assoc($sql_user)) { ?>
          <tr>
            ...
            <td><?=$data['username_pemilik']?></td>
            <td><?=$data['password_pemilik']?></td>
